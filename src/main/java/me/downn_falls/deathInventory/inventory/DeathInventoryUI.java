                ...
                if (player.hasPermission("deathinventory.death.death"+ finalI)) {
                    if (playerData.getDeathData().getList().get(0) != null) {
                        death.setDisplayItem(new ItemStackBuilder(
                                ...
                                .setDisplayName(configGUI.getString("death"+finalI+".full.display_name").replace("{death}", "" + deathData.getDeathCount()))
                    ...
                    if (playerData.getDeathData().getList().get(0) != null) {
                        death.setDisplayItem(new ItemStackBuilder(
                                ...
                                .setDisplayName(configGUI.getString("death"+finalI+".full_lock.display_name").replace("{death}", "" + deathData.getDeathCount()))
